...
#  system_create_dtsi
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field solr_name('desc_metadata__file_format', :facetable), :label => "File Format", :limit => 5
  ...
  def depositor 
    self.class.solr_name('depositor', :stored_searchable, type: :string)
  end
