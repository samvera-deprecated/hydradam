...
class GenericFile < ActiveFedora::Base
  ...
  delegate_to 'descMetadata', [:has_location, :program_title, :series_title, :item_title,
              ...
              :rights_holder, :release_date, :creator_attributes, :contributor_attributes, :publisher_attributes, 
  ...
  attr_accessible  :part_of, :contributor_attributes, :creator_attributes, :title_attributes,
        ...
        :production_location, :date_portrayed, :source, :source_reference, :rights_holder, :release_date, :tag,
  ...
  def terms_for_display
    [ :part_of, :contributor, :creator, :title, :description, :event_location, :production_location,
      :date_portrayed, :source, :source_reference, :rights_holder, :release_date, :publisher, :date_created, :date_uploaded,
