module RDF
  module EbuCore
    class Datastream < ActiveFedora::NtriplesRDFDatastream
      ...
      property :date_modified, predicate: RDF::EbuCore::Vocabulary.dateModified do |index|
        index.type :date
        index.as :stored_searchable
      end

      property :date_created, predicate: RDF::EbuCore::Vocabulary.dateCreated do |index|
        index.type :date
        index.as :stored_searchable
      end

      property :contributor, predicate: RDF::EbuCore::Vocabulary.hasContributor, class_name: 'Person'
      property :creator, predicate: RDF::EbuCore::Vocabulary.hasCreator, class_name: 'Person'
      property :publisher, predicate: RDF::EbuCore::Vocabulary.hasPublisher, class_name: 'Person'
      ...
      property :duration, predicate: RDF::EbuCore::Vocabulary.duration do |index|
        index.as :stored_searchable
      end
      ...
      class Location < ActiveFedora::Rdf::Resource
      ...
      class Rights < ActiveFedora::Rdf::Resource
      ...
      class DepictedEvent < ActiveFedora::Rdf::Resource
        configure type: RDF::EbuCore::Vocabulary.DepictedEvent
        property :date_time, predicate: RDF::EbuCore::Vocabulary.dateTime
      end

      class PublicationEvent < ActiveFedora::Rdf::Resource
      ...
      class Resource < ActiveFedora::Rdf::Resource
      ...
      class Track < ActiveFedora::Rdf::Resource
