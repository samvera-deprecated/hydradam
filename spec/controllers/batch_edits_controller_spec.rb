...
describe BatchEditsController do
  ...
  describe "update" do
    ...
    it "should be successful" do
      pending "MZ copied this test from Sufia. It doesn't work their either. See https://github.com/projecthydra/sufia/commit/7a626dea2e50f60782a510caa4a3b37adf8f0296#commitcomment-3579990"
